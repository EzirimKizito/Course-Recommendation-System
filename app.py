...
input_data['Learning style'] = st.selectbox('Learning Style', options=['calculation', 'calculations', 'kinesthetics', 'logical', 'writing', 'Auditory', 'Reading'])
input_data['Work experience'] = st.selectbox('Work Experience', options=['No', 'Yes'])
input_data['Academic subjects'] = st.selectbox('Academic Subjects', options=['maths', 'computer science', 'physics', 'biology', 'further maths', 'chemistry', 'English', 'civic', 'literature', 'civic education', 'government'])
input_data['Subject dislikes'] = st.selectbox('Subject Dislikes', options=['economics', 'english', 'Agric', 'geography', 'biology', 'civic', 'maths', 'physics', 'chemistry'])
input_data['Strengths'] = st.selectbox('Strengths', options=['critical thinking', 'technical proficiency', 'team collaboration', 'communication', 'creativity', 'team work'])
input_data['Weakness'] = st.selectbox('Weakness', options=['writing', 'Time management', 'public speaking', 'concentration', 'Technical skills', 'communication'])
